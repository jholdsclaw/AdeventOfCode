...
namespace Day1 {
    ...
    void Avatar::parseInput(std::string const &input) {
        ...
        while (ss.good()) {
            ...
            switch (substr[0]) {
                case 'R':
                    this->turn(RIGHT, atoi(substr.substr(1).c_str()));
                    break;
                case 'L':
                    this->turn(LEFT, atoi(substr.substr(1).c_str()));
                    break;
            }
        }
    }
